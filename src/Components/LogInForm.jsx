  ...
  return (
    <form onSubmit={handlingSubmit} className='flex flex-wrap justify-center w-11/12 sm:w-[400px] h-min py-6 my-5 mx-auto rounded-lg bg-gradient-to-r from-purple-500 to-pink-500'>
      <div className='flex justify-center items-center mb-5 w-full'>
        ...
        <h1 className='text-4xl p-1 '>Iniciar sesion</h1>
      </div>
      <div className='w-full mx-2'>
        <Input type={"text"} name={"luname"} title={"Nombre de Usuario:"} required={true} />
        <Input type={"password"} name={"password"} title={"Contraseña:"} required={true} />
        <div className='flex justify-center flex-wrap w-full my-1'>
          <button type='submit' className='w-full py-2 mx-1 rounded-lg cursor-pointer bg-gradient-to-r from-sky-500 to-indigo-500'>
            Iniciar Sesion
          </button>
        </div>
      </div>
